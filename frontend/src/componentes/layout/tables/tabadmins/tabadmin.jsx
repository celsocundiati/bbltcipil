...
//                 setAdmins(data); // pega todos os usuários filtrados pelo backend
//             } catch (err) {
...
//         if (user.grupos?.includes("Admin")) return "Admin";
//         if (user.grupos?.includes("Bibliotecario")) return "Bibliotecário";
//         return "—";
//     };
...
//                                 <th className="w-[10%] px-5 py-3 text-center">Usuário</th>
...
//                                         <td className="px-5 py-4 truncate text-center">{adm.username}</td>

//                                         <td className="px-5 py-4 truncate text-center">
//                                             <span className={`px-3 py-1 text-center rounded text-sm ${
//                                                 adm.is_superuser
...
//                             {modal.type === "delete" ? "Excluir usuário" : "Editar usuário"}
//                         </h3>
//                         <p className="text-lg">Tem certeza que deseja{" "}
//                             {modal.type === "delete" ? "excluir" : "editar"} este usuário?
//                         </p>
