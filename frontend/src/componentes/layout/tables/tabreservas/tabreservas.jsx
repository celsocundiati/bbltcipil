...
//                                                         ? "bg-[#f97b17]/20 text-black font-medium"
//                                                         : "hover:bg-gray-100"
...
//     // ==========================
//     const podeEmprestar = (reserva) => {
//         return reserva.estado === "reservado" && userRoles.includes("Funcionario");
//     };

//     const podeFinalizar = (reserva) => {
//         return reserva.estado === "em_uso" && userRoles.includes("Funcionario");
//     };
...
//             alert("Você não tem permissão para emprestar esta reserva.");
//             return;
//         }
//         setReservaSelecionada(reserva);
//     };
...
//     //             return <span className="text-gray-500">—</span>;
//     //         case "reservado":
//     //             return userRoles.includes("Bibliotecario") ? (
//     //                 <button
//     //                     onClick={() => handleAprovar(reserva.id)}
//     //                     className="px-3 py-1 rounded-full text-sm font-medium cursor-pointer
//     //                                bg-blue-100 text-blue-600 border border-blue-200
...
//     // Ação principal (Aprovar/Finalizar) apenas para Bibliotecário/Administrador
//     const renderAcaoPrincipal = (reserva) => {
//         if (["Bibliotecario", "Admin"].some(role => userRoles.includes(role))) {
//             switch (reserva.estado) {
//                 case "pendente":
//                     return <span className="text-gray-500">—</span>;
//                 case "reservado":
...
//             }
//         }
//         // Funcionario e aluno não podem aprovar nem finalizar
//         return <span className="text-gray-500">—</span>;
//     };
