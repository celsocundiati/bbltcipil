...
//               Aplique multas à usuários irresponsáveis e com falta de seriedade
//             </p>
//           </article>
...
//                 <label className="text-black/75 text-lg">Usuário</label>
//                 <input
//                   type="text"
...
//               <div className="flex flex-col space-y-1">
//                 <label className="text-black/75 text-lg">Delimita o valor a ser cobrado</label>
//                 <input
//                   type="number"
//                   className="bg-black/5 cursor-not-allowed outline-none py-2 px-3 rounded-lg"
//                 />
...
//               <div className="flex flex-col space-y-1">
//                 <label className="text-black/75 text-lg">Data </label>
//                 <input
//                   type="date"
//                   name="data"
//                   required
