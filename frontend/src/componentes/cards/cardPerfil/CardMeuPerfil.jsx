                ...
                <section className="flex flex-col gap-2">
                    ...
                    <div className="flex flex-col gap-2 py-1">
                        <span className="flex items-center gap-2"> 
                            <AiOutlineMail size={18} className="text-[#F97B17]"/> <p className="text-[#000000]/57 text-sm">cristianocarvalh207@gmail.com</p>
                        </span>
                        <span className="flex items-center gap-2"> 
                            <HiOutlineHashtag size={18} className="text-[#F97B17]"/> <p className="text-[#000000]/57 text-sm">Matricula: 71286</p>
                        </span>
                    </div>
                    <div className="flex justify-between gap-2 py-3">
                        ...
                        <div className="flex flex-col bg-[#F97B17]/10 text-[#F86417] font-medium py-3 px-6 rounded-lg">
                            <label className="text-center ">3</label>
