...
from .views import SignupView, LoginView, RefreshTokenView, LogoutView, MeView, AlterarSenhaView, password_reset_request, password_reset_confirm, VerifyEmailView
